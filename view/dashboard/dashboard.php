        ...
        <aside id="sidebar" class="side">
            <div class="h-100">
                <div class="sidebar_logo d-flex align-items-end">
                    ...
                    <img class="close align-self-start" src="assests/styles/img/close.svg" alt="icon">
                </div>
                ...
                <div class="line"></div>
                <a href="#" class="sidebar_link"><img src="assets/styles/img/settings.svg" alt="icon">Settings</a>
            ...
            <nav class="navbar justify-content-space-between pe-4 ps-2">
                ...
                <div class="navbar  gap-4">
                    <div class="">
                        ...
                        <img class="search_icon" src="assests/styles/img/search.svg" alt="iconicon">
                    </div>
                    ...
                    <div class="card new w-auto">
                        <div class="list-group list-group-light">
                            <div class="list-group-item px-3 d-flex justify-content-between align-items-center ">
                                <p class="mt-auto">Notification</p><a href="#"><img src="assests/styles/img/settingsno.svg" alt="icon"></a>
                            </div>
                            <div class="list-group-item px-3 d-flex"><img src="assests/styles/img/notif.svg" alt="iconimage">
                                <div class="card-body">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-icon pe-md-0 position-relative" data-bs-toggle="dropdown">
                                <img src="assests/styles/img/photo_admin.svg" alt="icon">
                            </a>
                        ...
                        <div class="card">
                            <div class="card-body  p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="cursor">
                                        <img src="assets/styles/img/project-icon-1.svg" alt="icon">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="">
                                        <img src="assets/styles/img/project-icon-2.svg" alt="icon">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="">
                                        <img src="assets/styles/img/project-icon-3.svg" alt="icon">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="">
                                        <img src="assets/styles/img/project-icon-4.svg" alt="icon">
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="Admin_task list-group">
                        <div class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
                            ...
                            <img class="cursor " id="add_admin_task" src="assests/styles/img/inactive.svg" alt="icon">
                        </div>
                        <div class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
                            <p>Finish offre update</p>
                            <img src="assests/styles/img/warning.svg" alt="icon">
                        </div>
                        <div class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
                            <p>Create new offre example</p>
                            <img src="assests/styles/img/successnew.svg" alt="icon">
                        </div>
                        <div class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
                            <p>Update offre report</p>
                            <img src="assests/styles/img/default.svg" alt="icon">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form id="forms">
                ...
                <div class="mb-4">
                    ...
                    <select class="form-control" name="task status" id="status">
                        <option value="assets/styles/img/default.svg">Default</option>
                        <option value="assets/styles/img/successnew.svg">New</option>
                        <option value="assets/styles/img/warning.svg">Urgent</option>
                    </select>
                </div>
