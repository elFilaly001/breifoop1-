                ...
                <div class="col pX0">
                    <div class="bg-cont navbar justify-content-space-between pe-4 ps-2">
                        ...
                        <div class="navbar  gap-4">
                            <div class="">
                                <input type="search" class="search " placeholder="Search">
                                <img class="search_icon" src="assets/styles/img/search.svg" alt="icon">
                            </div>
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    <a href="#" class="nav-icon pe-md-0 position-relative" data-bs-toggle="dropdown">
                                        <img src="assets/styles/img/carbon.svg" alt="">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-end position-absolute">
                                        <a class="dropdown-item" href="#">Profile</a>
                                        <a class="dropdown-item" href="#">Account Setting</a>
                    ...
                    <div class="container pX0">
                        <div class="bg-white navbar justify-content-between">
                            ...
                            <div class="navbar  gap-4">
                                <img src="assets/styles/img/check.svg" alt="icon" style="width:2rem;">
                ...
                <div class="col pX0">
                    ...
                    <div class="d-flex justify-content-end flex-column " id="Message" style="height: 25rem;">
                        <div class="w-50 bg-white p-2 mb-3 me-4 rounded d-flex justify-content-between">
                            ...
                            <img src="assets/styles/img/check-all.svg" alt="icon">
                        </div>
                    </div>
                    <div class="bg-cont navbar ">
                        <img class="cursor" src="assets/styles/img/smail.svg" alt="icon">
                        <img class="cursor" src="assets/styles/img/fille.svg" alt="icon">
                        <div class="form-outline">
                            <input type="text" id="form12" class="massege_input form-control">
                        </div>
                        <img class="cursor send-message" src="assets/styles/img/sand.svg" alt="icon">
                    </div>
                </div>
            </div>
        </div>
